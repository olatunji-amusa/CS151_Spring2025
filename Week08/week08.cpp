/*
    ...
    the program should display "four." Use a switch statement to determine the
    word to display from the array. There should 10 cases [0,9]. If the number is not between 0 and 9, the program should 
